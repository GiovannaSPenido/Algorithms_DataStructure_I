...
public class C11EX02A_GiovannaPenido {
    public static void main(String[] args) {
        ...
        System.out.printf("Média das aplicações dos clientes Bronze = R$ %.2f", mediaB);
        System.out.printf("Volume total das aplicações = R$ %.2f", volumeT);
